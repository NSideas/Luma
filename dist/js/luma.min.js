...
function globalResizeHandler(){headerResize(),$("#staff-list").length&&staffList()}function toggleScrollTop(e){window.scrollY>e&&!top_button_visible?($("#scroll-top-container").fadeIn(300),top_button_visible=!0):window.scrollY<=e&&($("#scroll-top-container").fadeOut(300),top_button_visible=!1)}function globalScrollHandler(){clearTimeout(timeout),headerScroll(),mq_medium.matches&&toggleScrollTop(window.innerHeight/2),timeout=setTimeout(function(){headerScroll(),mq_medium.matches&&toggleScrollTop(window.innerHeight/2)},250)}var mq_small=window.matchMedia("(min-width: 480px)"),mq_medium=window.matchMedia("(min-width: 720px)"),mq_large=window.matchMedia("(min-width: 860px)"),mq_xl=window.matchMedia("(min-width: 960px)");
// Browser test
bowser.msie?$("html").addClass("ie"):bowser.msedge?$("html").addClass("msedge"):bowser.firefox&&$("html").addClass("firefox");
// Touch screen test
var touch=!0;$("html").addClass("touch"),document.addEventListener("touchstart",touchHandler,{once:!0}),document.addEventListener("mousemove",mouseMoveHandler,{once:!0});var scrollTopBtn=document.getElementById("btn-scroll-top");scrollTopBtn.addEventListener("click",smoothScrollTop),
