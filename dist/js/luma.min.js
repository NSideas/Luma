...
// Team
function staffList(){var t=$("#staff-list").width(),a=$("#staff-list")[0].getBoundingClientRect().x;$(".team-member-bio").each(function(){$(this).css("left","0"),$(this).width(t);var e=$(this)[0].getBoundingClientRect().x;if(e!==a){var o=e-a;$(this).css("left","-"+o+"px")}})}
...
// Touch screen test
var touch=!0;$("html").addClass("touch"),document.addEventListener("touchstart",touchHandler,{once:!0}),document.addEventListener("mousemove",mouseMoveHandler,{once:!0});var scrollTopBtn=document.getElementById("btn-scroll-top");scrollTopBtn.addEventListener("click",function(e){e.preventDefault(),window.scrollTo({top:0,behavior:"smooth"})}),
